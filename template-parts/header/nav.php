            ...
            <ul class="navbar-nav mr-auto">
                ...
                foreach ($header_menus as $menu_item) {
                    if (!$menu_item->menu_item_parent) {
                        ...
                        $has_children = !empty($has_children_menu_items) && is_array($child_menu_items);
                        if (!$has_children) {
                ?>
                            <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <php? foreach ($child_menu_items as $child_menu_item){ ?>
                                        <a class="dropdown-item" href="<?php echo  esc_url($child_menu_item->url) ?>"><?php esc_html($child_menu_item->title); ?></a>
